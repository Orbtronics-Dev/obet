...
export function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-[#060810] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#007BFF]/6 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="bg-[#0d1320] border border-[rgba(0,123,255,0.18)] rounded-2xl p-8 shadow-2xl shadow-black/40">
          <h1 className="font-poppins text-2xl font-bold text-white mb-1">Welcome back</h1>
          <p className="text-gray-500 text-sm font-inter mb-8">Sign in to your OBet account</p>
          ...
          <p className="text-gray-600 text-sm text-center mt-6 font-inter">
            No account?{" "}
            <Link href="/register" className="text-[#007BFF] hover:text-[#3395ff] transition-colors font-medium">
              Create one free
            </Link>
          </p>
        </div>
